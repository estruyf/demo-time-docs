...
lastmod: 2025-07-02T12:10:41.903Z
...
| `demoTime.insertTypingMode` | The typing mode for inserting text. Options are: `instant`, `line-by-line`, or `character-by-character` | `instant` |
