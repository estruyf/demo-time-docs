...
In the [getting started](/demo-time-docs/getting-started/) guide, you learned how to initialize the extension with a sample demo. In this guide, you will learn how to add your demos to the demo time configuration.
...
6. Select the type of action you want to add (insert, highlight, unselect, or delete).
  <Image class="mx-auto" src={demoStepImage} alt="Add a demo step from the &quot;Demo Time: Add as demo step&quot; command" />
...
You can add more demos and steps to the `demos` array. In the [actions section](/demo-time-docs/actions/) of the documenation, you can find all the available actions you can use to create your demos.
