...
In the [getting started](/demo-time-docs/docs/) guide, you learned how to initialize the extension with a sample demo. In this guide, you will learn how to add your demos to the demo time configuration.
...
You can add more demos and steps to the `demos` array. In the [actions section](/demo-time-docs/docs/actions/file) of the documenation, you can find all the available actions you can use to create your demos.
