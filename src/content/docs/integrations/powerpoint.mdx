...
lastmod: 2025-06-16T16:15:46.716Z
---
...
2. **Add the Add-in to Your Presentation**  
   ...
   - The initial view from the add-in will ask you for the `Server URL` and `Command ID`
      - The `Server URL` is the URL of the Demo Time API, which is typically `http://localhost:3710`.
      - The `Command ID` is the ID of the command you want to trigger from your script.
